...
def get_font(font_name: str, font_size: int) -> pg.font.Font:
    ...
    pg.font.SysFont is expensive to call and should never be invoked every frame. This
    function ensures each unique (font_name, font_size) combination is created only once
